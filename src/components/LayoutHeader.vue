  ...
  <div class="py-2 border-t-2 border-primary">
    <div class="container">
      ...
      <div class="-mx-4 flex justify-between items-center">
        <div class="px-4 flex items-center mr-auto">
          <g-link
            to="/"
          ...
          >
            ...
            <span class="font-black uppercase tracking-tighter text-xl ml-2">
              {{ meta.siteName }}
            </span>
          </g-link>

          <div v-if="settings.nav.links.length > 0" class="ml-8 mr-5">
            <g-link
        ...
        <div class="px-4 w-full max-w-screen-xs">
          <Search />
        </div>
        ...
        <div class="px-4 flex justify-end items-center">
          ...
          <a v-if="settings.twitter" :href="settings.twitter" class="ml-3" target="_blank" rel="noopener noreferrer" title="Twitter" name="Twitter">
